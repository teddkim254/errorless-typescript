...
function doSleuthing(numberOfClues:number, clue1:string, clue2:string, suspect1:string, suspect2:string):number{
  ...
  console.log('Now, I will return to you the culprit. There but for the grace of God go we.' );
   ...
   console.log("I couldn't figure out who drank the priceless milk. :( :(");
  }
